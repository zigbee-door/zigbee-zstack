...
#define BASEAPP_SEND_PERIODIC_MSG_TIMEOUT   5000  // Every 5 seconds 定时事件的时间,每隔5s触发一次

// Application Events (OSAL) - These are bit weighted definitions.
#define BASEAPP_SEND_PERIODIC_MSG_EVT       0x0001  //定时事件标志
  
// Group ID for Flash Command
#define BASEAPP_FLASH_GROUP                  0x0001 //组ID定义
