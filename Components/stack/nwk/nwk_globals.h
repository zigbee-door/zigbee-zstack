...
#define NWK_MODE_STAR         0 //星型
#define NWK_MODE_TREE         1 //树型
...
#define MAX_CHANNELS_24GHZ      0x07FFF800
...
#if defined ( ZIGBEEPRO )                     //查看工程配置里确实定义了这个
  ...
  #define STACK_PROFILE_ID      HOME_CONTROLS
    ...
    #define MAX_NODE_DEPTH      20                  //定义默认网络深度为20
    #define NWK_MODE            NWK_MODE_MESH       //定义网状结构
    #define SECURITY_MODE       SECURITY_COMMERCIAL //定义安全模式
  #if   ( SECURE != 0  )
